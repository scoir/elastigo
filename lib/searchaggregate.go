...
type FieldOnlyAggregate struct {
...
func (d *AggregateDsl) Min(field string) *AggregateDsl {
	d.Type = FieldOnlyAggregate{Field: field}
	d.TypeName = "min"
	return d
}
...
func (d *AggregateDsl) SumWithScript(script string) *AggregateDsl {
	d.Type = Sum{Script: script}
	d.TypeName = "sum"
	return d
}
...
func (d *AggregateDsl) Nested(path string) *AggregateDsl {
	d.Type = NestedAggregate{Path: path}
	d.TypeName = "nested"
	return d
}

func (d *AggregateDsl) ReverseNested() *AggregateDsl {
	d.Type = ReverseNestedAggregate{}
...
func (d *AggregateDsl) TermsWithSizeAndOrder(field string, size int, orderField, orderDirection string) *AggregateDsl {
	order := map[string]string{
		orderField: orderDirection,
	}
	d.Type = FieldAggregate{Field: field, Size: size, Order: order}
	d.TypeName = "terms"
	return d
}

func (d *AggregateDsl) TermsWithSizeAndInclude(field string, size int, include interface{}) *AggregateDsl {
	d.Type = FieldAggregate{Field: field, Size: size, Include: include}
	d.TypeName = "terms"
	return d
}
