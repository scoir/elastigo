...
type Hit struct {
	...
	InnerHits   map[string]InnerHitResult `json:"inner_hits,omitempty"` // when a field arg is passed to ES, instead of _source it returns fields
	Explanation *Explanation              `json:"_explanation,omitempty"`
	Highlight   *Highlight                `json:"highlight,omitempty"`
}

type InnerHitResult struct {
	Hits Hits `json:"hits"`
}
